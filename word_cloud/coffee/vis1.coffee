...
Bubbles = () ->
  ...
  updateActive = (id) ->
    ...
    if id.length > 0
      d3.select("#status").html("<h3>The word <span class=\"active\">#{id}</span> occured #{rValue(id)} times</h3>")
    else
...
texts = [
  {key:"EdSheeran",file:"EdSheeran.csv",name:"EdSheeran"}
  {key:"BillieEilish",file:"BillieEilish.csv",name:"BillieEilish"}
  {key:"KatyPerry",file:"KatyPerry.csv",name:"KatyPerry"}
  {key:"Rihanna",file:"Rihanna.csv",name:"Rihanna"}
  {key:"NickiMinaj",file:"NickiMinaj.csv",name:"NickiMinaj"}
  {key:"ColdPlay",file:"ColdPlay.csv",name:"ColdPlay"}
  {key:"DuaLipa",file:"DuaLipa.csv",name:"DuaLipa"}
  {key:"ArianaGrande",file:"ArianaGrande.csv",name:"ArianaGrande"}
  {key:"CardiB",file:"CardiB.csv",name:"CardiB"}
  {key:"Beyonce",file:"Beyonce.csv",name:"Beyonce"}
  {key:"Khalid",file:"Khalid.csv",name:"Khalid"}
  {key:"Maroon5",file:"Maroon5.csv",name:"Maroon5"}
  {key:"Eminem",file:"Eminem.csv",name:"Eminem"}
  {key:"CharliePuth",file:"CharliePuth.csv",name:"CharliePuth"}
  {key:"SelenaGomez",file:"SelenaGomez.csv",name:"SelenaGomez"}
  {key:"JustinBieber",file:"JustinBieber.csv",name:"JustinBieber"}
  {key:"LadyGaga",file:"LadyGaga.csv",name:"LadyGaga"}
  {key:"BTS",file:"BTS.csv",name:"BTS"}
  {key:"PostMalone",file:"PostMalone.csv",name:"PostMalone"}
  {key:"Drake",file:"Drake.csv",name:"Drake"}
  {key:"TaylorSwift",file:"TaylorSwift.csv",name:"TaylorSwift"}
]
...
$ ->
  ...
  d3.select("#book-title").html('<p>Top 50 words most frequently used in lyrics by <span style="color:orange">'+text.name+'</span></p>')
