...
texts = [
  {key:"1",file:"five_yr_1.csv",name:"1965-1969"}
  {key:"2",file:"five_yr_2.csv",name:"1970-1974"}
  {key:"3",file:"five_yr_3.csv",name:"1975-1979"}
  {key:"4",file:"five_yr_4.csv",name:"1980-1984"}
  {key:"5",file:"five_yr_5.csv",name:"1985-1989"}
  {key:"6",file:"five_yr_6.csv",name:"1990-1994"}
  {key:"7",file:"five_yr_7.csv",name:"1995-1999"}
  {key:"8",file:"five_yr_8.csv",name:"2000-2004"}
  {key:"9",file:"five_yr_9.csv",name:"2005-2009"}
  {key:"10",file:"five_yr_10.csv",name:"2010-2014"}
]
...
$ ->
  ...
  d3.select("#book-title").html('<p>In <span style="color:orange">'+text.name+'</span> top 50 words most frequently used in lyrics by artists.</p>')
