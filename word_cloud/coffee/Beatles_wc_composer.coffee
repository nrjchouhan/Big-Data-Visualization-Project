...
texts = [
  {key:"McCartney",file:"Beatles_McCartney.csv",name:"McCartney"}
  {key:"Lennon",file:"Beatles_Lennon.csv",name:"Lennon"}
  {key:"Starr",file:"Beatles_Starr.csv",name:"Starr"}
  {key:"Harrison",file:"Beatles_Harrison.csv",name:"Harrison"}
]
...
$ ->
  ...
  #   $('#text-select').empty()
    ...
    # # Populate the options in the second dropdown based on the selected value
    # switch selected_value
    #   when 'yearwise'
    #     $('#text-select').append('<option value="1">1965-1969</option>
    #     <option value="2">1970-1974</option>
    #     <option value="3">1975-1979</option>
    #     <option value="4">1980-1984</option>
    #     <option value="5">1985-1989</option>
    #     <option value="6">1990-1994</option>
    #     <option value="7">1995-1999</option>
    #     <option value="8">2000-2004</option>
    #     <option value="9">2005-2009</option>
    #     <option value="10">2010-2014</option>')
    #   when 'artistwise'
    #     $('#text-select').append('<option value="EdSheeran">Ed Sheeran</option>
  ...
  d3.select("#book-title").html('<p>Top 50 words most frequently used in Beatles lyrics by <span style="color:orange">'+text.name+'</span></p>')
